...
// ─── Auto Active Nav (URL-based) ─────────────────────────────────────────────
;(function () {
  const page = window.location.pathname.split('/').pop() || 'index.html'

  // Clear all hardcoded active states
  $('.nav-item').removeClass('active')
  $('.dropdown-menu a').removeClass('nav-active')
  $('.mobile-item').removeClass('active')
  $('.mobile-sub a').removeClass('nav-active')
  ...
  $('.nav-item').each(function () {
    ...
    if ($item.hasClass('has-dropdown')) {
      $item.find('.dropdown-menu a').each(function () {
      ...
      const href = ($item.children('.nav-link').attr('href') || '').split('/').pop()
      if (href && href === page) $item.addClass('active')
    }
  })
  ...
  $('.mobile-item').each(function () {
    ...
    if ($item.hasClass('has-sub')) {
      $item.find('.mobile-sub a').each(function () {
        const href = ($(this).attr('href') || '').split('/').pop()
        if (href && href === page) {
          $item.addClass('active')
          $(this).addClass('nav-active')
      ...
      const href = ($item.children('a').first().attr('href') || '').split('/').pop()
      if (href && href === page) $item.addClass('active')
    }
  })
})()
