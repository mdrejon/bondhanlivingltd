    ...
    <AdminLayout>
        <div class="max-w-2xl space-y-6">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-lg font-semibold text-gray-800">Edit Room: {{ room.room_number }}</h1>
            </div>
            ...
            <form @submit.prevent="submit" class="bg-white rounded-lg shadow-sm p-6 space-y-5">
                ...
                <div>
                    ...
                    <DropZone @change="onImageChange" hint="JPEG / PNG / WebP — max 5 MB"
                        :existing-preview="room.image ? '/storage/' + room.image : null" />
                </div>
                ...
                <div class="flex justify-end gap-3 pt-2">
                    ...
                    <button type="submit" :disabled="form.processing"
                        ...
                        {{ form.processing ? 'Saving...' : 'Update Room' }}
                    </button>
                </div>
            </form>
        </div>
