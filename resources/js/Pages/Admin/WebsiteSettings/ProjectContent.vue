                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <input
                                            type="file"
                                            id="hero_bg_image"
                                            @change="e => form.project_page_hero.bg_image_file = e.target.files[0]"
                                            class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                        />
                                        <div v-if="form.project_page_hero.bg_image" class="mt-2">
                                            <img :src="`/storage/${form.project_page_hero.bg_image}`" class="h-20 object-cover rounded" />
                                        </div>
                                    </div>
                                </div>
                            </div>
