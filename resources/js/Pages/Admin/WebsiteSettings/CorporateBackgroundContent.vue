<template>
  <Head title="Corporate Background Content" />

  <AdminLayout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
      <div class="sm:flex sm:justify-between sm:items-center mb-8">
        <div class="mb-4 sm:mb-0">
          <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Corporate Background Content ✨</h1>
        </div>
            ...
            <div v-show="activeTab === 'hero'">
              ...
              <div class="grid gap-5">
                <div>
                  ...
                  <input v-model="form.corporate_page_hero.title" type="text" class="form-input w-full" />
                </div>
                <div>
            ...
            <div v-show="activeTab === 'main'">
              ...
              <div class="grid gap-5">
                <div>
                  ...
                  <input v-model="form.corporate_page_main.subtitle" type="text" class="form-input w-full" />
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                      <label class="block text-sm font-medium mb-1">Title</label>
                      <input v-model="form.corporate_page_main.title" type="text" class="form-input w-full" />
                    </div>
                    <div>
                      <label class="block text-sm font-medium mb-1">Title Highlight (Red text)</label>
                      <input v-model="form.corporate_page_main.highlight" type="text" class="form-input w-full" />
                    </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea v-model="form.corporate_page_main.description" rows="8" class="form-textarea w-full"></textarea>
                </div>
                <div>
            ...
            <div v-show="activeTab === 'seo'">
              ...
              <div class="grid gap-5">
                <div>
                  ...
                  <input v-model="form.corporate_page_seo.meta_title" type="text" class="form-input w-full" />
                </div>
                <div>
                  <label class="block text-sm font-medium mb-1">Meta Description</label>
                  <textarea v-model="form.corporate_page_seo.meta_description" rows="3" class="form-textarea w-full"></textarea>
                </div>
                <div>
                  <label class="block text-sm font-medium mb-1">Meta Keywords</label>
                  <input v-model="form.corporate_page_seo.meta_keywords" type="text" class="form-input w-full" />
                </div>
                <div>
                  <label class="block text-sm font-medium mb-1">Meta Author</label>
                  <input v-model="form.corporate_page_seo.meta_author" type="text" class="form-input w-full" />
                </div>
              </div>
            </div>
          </form>
...
const form = useForm({
  corporate_page_hero: props.content.corporate_page_hero || { title: '', bg_image: '', bg_image_file: null },
  corporate_page_main: props.content.corporate_page_main || { subtitle: '', title: '', highlight: '', description: '', bg_image: '', image: '', bg_image_file: null, image_file: null },
  corporate_page_seo: props.content.corporate_page_seo || { meta_title: '', meta_description: '', meta_keywords: '', meta_author: '' }
});

const submitForm = () => {
  form.post(route('admin.website-settings.corporate-content.update'), {
    preserveScroll: true,
    forceFormData: true,
  });
};
