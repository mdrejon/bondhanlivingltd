    ...
    <AdminLayout>
        <div class="max-w-7xl space-y-6">
            <div class="flex items-center justify-between">
                <h1 class="text-lg font-semibold text-gray-800">All Bookings</h1>
                <div class="flex items-center gap-3">
                    <BookingPdfExportModal type="all" title="All Bookings List" />
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-9 gap-3">
                ...
                <div class="bg-green-50 rounded-lg shadow-sm p-3 text-center border border-green-200">
                    ...
                    <div class="text-xs text-gray-400 mt-0.5">Online</div>
                </div>
                <div class="bg-blue-50 rounded-lg shadow-sm p-3 text-center border border-blue-200">
                    <div class="text-xl font-bold text-blue-600">{{ manualCount }}</div>
                    <div class="text-xs text-gray-400 mt-0.5">Manual</div>
                </div>
                ...
                <div class="bg-indigo-50 rounded-lg shadow-sm p-3 text-center border border-indigo-200">
                    <div class="text-xl font-bold text-indigo-600">{{ statusCount('confirmed') }}</div>
                ...
                <div class="bg-emerald-50 rounded-lg shadow-sm p-3 text-center border border-emerald-200">
                    <div class="text-xl font-bold text-emerald-600">{{ statusCount('checked_in') }}</div>
                ...
                <table class="w-full text-sm min-w-[1000px]">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr v-if="filtered.length === 0">
                            <td colspan="11" class="px-3 py-8 text-center text-gray-400 text-sm">No bookings found.</td>
                        </tr>
...
const onlineCount = computed(() => props.bookings.filter(b => b.source === 'web').length);
const manualCount = computed(() => props.bookings.filter(b => b.source === 'admin').length);
