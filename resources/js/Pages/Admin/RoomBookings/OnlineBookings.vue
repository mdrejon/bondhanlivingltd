    ...
    <AdminLayout>
        <div class="max-w-7xl space-y-6">
            <div class="flex items-center justify-between">
                <h1 class="text-lg font-semibold text-gray-800">Online Bookings</h1>
                <div class="flex items-center gap-3">
                    <BookingPdfExportModal type="online" title="Online Bookings List" />
            ...
            <div class="grid grid-cols-4 sm:grid-cols-8 gap-3">
                <div class="bg-white rounded-lg shadow-sm p-3 text-center border border-gray-100">
                    ...
                    <div class="text-xs text-gray-400 mt-0.5">Total Online</div>
                </div>
                ...
                <table class="w-full text-sm min-w-[900px]">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr v-if="filtered.length === 0">
                            <td colspan="10" class="px-3 py-8 text-center text-gray-400 text-sm">No online bookings found.</td>
                        </tr>
